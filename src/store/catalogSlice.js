...
export const fetchFilteredCatalog = createAsyncThunk(
    ...
    async function (e, {rejectWithValue}) {
        try {
            const response = await fetch(`http://localhost:7070/api/items?q=${e}`);
            if (!response.ok) {
                throw new Error('Server Error');
            }
            const data = await response.json();
...
export const fetchLoadMore = createAsyncThunk(
    ...
    async function (p, {rejectWithValue}) {
        try {
            ...
            const response = await fetch(`http://localhost:7070/api/items?offset=${p}`);
            if (!response.ok) {
                throw new Error('Server Error');
            }
            const data = await response.json();
...
export const fetchLoadMoreFiltered = createAsyncThunk(
    ...
    async function (p, {rejectWithValue}) {
        const {pos, txt} = p;
        try {
            const response = await fetch(`http://localhost:7070/api/items?q=${txt}&offset=${pos}`);
            if (!response.ok) {
                throw new Error('Server Error');
            }
            const data = await response.json();
...
export const fetchLoadMoreCategory = createAsyncThunk(
    ...
    async function (p, {rejectWithValue}) {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:7070/api/items?categoryId=${cat}&offset=${pos}`);
            if (!response.ok) {
                throw new Error('Server Error');
            }
            const data = await response.json();
...
export const fetchFilteredCategory = createAsyncThunk(
    ...
    async function (p, {rejectWithValue}) {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:7070/api/items?q=${txt}&categoryId=${cat}`);
            if (!response.ok) {
                throw new Error('Server Error');
            }
            const data = await response.json();
...
export const fetchLoadMoreFilteredCategory = createAsyncThunk(
    ...
    async function (p, {rejectWithValue}) {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:7070/api/items?q=${txt}&categoryId=${cat}&offset=${pos}`);
            if (!response.ok) {
                throw new Error('Server Error');
            }
            const data = await response.json();
